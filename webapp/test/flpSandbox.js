		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Return Sales",
									"targetURL": "#comerosreturnsales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerosreturnsales-display": {
								"semanticObject": "comerosreturnsales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eros.returnsales",
									"url": sap.ui.require.toUrl("com/eros/returnsales")
								}
							}
						}
					}
